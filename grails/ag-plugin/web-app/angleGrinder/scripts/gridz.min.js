...
(function($) {
    ...
    $.fn.jqGrid = function(pin) {
        ...
        return this.each(function() {
            ...
            var arf = ts.p.hidegrid === true ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton' />").hover(function() {
...
(function($) {
    ...
    $.fn.fmatter.rowactions = function(act) {
        var $tr = $(this).closest("tr.jqgrow"), rid = $tr.attr("id"), $id = $(this).closest("table.ui-jqgrid-btable").attr("id").replace(/_frozen([^_]*)$/, "$1"), $grid = $("#" + $id), $t = $grid[0], p = $t.p, cm = p.colModel[$.jgrid.getCellIndex(this)], $actionsDiv = cm.frozen ? $("tr#" + rid + " td:eq(" + $.jgrid.getCellIndex(this) + ") > div", $grid) : $(this).parent(), op = {
            keys: false,
            onEdit: null,
            onSuccess: null,
            afterSave: null,
...
(function() {
    ...
    Gridz = function() {
        ...
        Gridz.prototype.getOptions = function(options) {
            var optBeforeSelectRow, _gridComplete, _this = this;
            ...
            options.gridComplete = function() {
                ...
                return _this.$grid.trigger("gridComplete");
            };
            if (options.actionPopup && options.sortable) {
                options.sortable = {
                    exclude: "#" + this.gridId + "_row_action_col"
                };
            }
            return options;
        };
        ...
        Gridz.prototype.beforeSelectRow = function(rowid, e) {
            ...
            rows = this.$grid[0].rows;
            startId = this.$grid.jqGrid("getGridParam", "selrow");
            startRow = void 0;
            endRow = void 0;
            iStart = void 0;
            iEnd = void 0;
            ...
            if (!e.ctrlKey && !e.shiftKey && !e.metaKey && !isCheckBox) {
                ...
                if (startRow && endRow) {
                    ...
                    while (i <= iEnd) {
                        if (i !== rowidIndex) {
                            this.$grid.jqGrid("setSelection", rows[i].id, false);
                        }
                        i++;
                    }
                }
        ...
        Gridz.prototype.addRowActionColumn = function() {
            var containerId, opts, self;
            self = this;
            opts = this.options;
            containerId = "gbox_" + this.$element.attr("id");
            return opts.colModel.unshift({
                name: "row_action_col",
                label: " ",
                width: 20,
                sortable: false,
                ...
                formatter: function(cellValue, colOptions, rowObject) {
                    var func;
                    func = opts.actionPopup.cellFormatter || self.actionPopupFormatter;
        ...
        Gridz.prototype.actionPopupOnShow = function(clickoverEl) {
            ...
            $menu.on("click", "li a.row_action_show", function(e) {
                e.preventDefault();
                return $grid.trigger("showAction", [ id, self ]);
            });
            $menu.on("click", "li a.row_action_edit", function(e) {
                e.preventDefault();
                return $grid.trigger("editAction", [ id, self ]);
            });
            return $menu.on("click", "li a.row_action_delete", function(e) {
                e.preventDefault();
                return $grid.trigger("deleteAction", [ id, self ]);
            });
        };
        return Gridz;
    }();
    ...
    $.fn.gridz = function(option) {
        ...
        return this.each(function() {
            ...
            if (!instance) {
                return $this.data("gridz", instance = new Gridz(this, options));
            }
        });
    };
